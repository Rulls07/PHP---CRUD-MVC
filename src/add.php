<?php require 'database.php';
        if ($_SERVER["REQUEST_METHOD"] == "POST" && !empty($_POST)) { //on initialise nos messages d'erreurs; 
            $nameError = ''; $firstnameError=''; $ageError=''; $telError =''; $emailError =''; $paysError=''; $commentError=''; $metierError=''; $urlError=''; // on recupère nos valeurs 
...
//-------------------------------------  Input Metier  
                ...
                if(empty($url)){ 
                    ...
                    $valid= false; } 
                        ...
                        $valid=false; } // si les données sont présentes et bonnes, on se connecte à la base 
